...
public class LoginActivity extends Activity {
		...
		mLoginButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (username.isEmpty() || password.isEmpty()) {
					...
					Notes.loginUser(new Credentials(username, password), new Callback<AccessToken>() {
                        @Override
                        public void success(AccessToken accessToken, Response response) {
                            // Success!
                            NotesAndroidSettings settings = new NotesAndroidSettings(getApplicationContext());
                            settings.setAccessTokenPreference(accessToken.accessToken);
                            settings.setUsernamePreference(accessToken.username);
    ...
    private void alertUserBoutError() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LoginActivity.this);
